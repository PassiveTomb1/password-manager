...
PasswordManager::PasswordManager()
{
    ...
    ifstream pass("passwords.csv");
    if (!pass.is_open())
    {
        ofstream pass("passwords.csv");
    }
    else
    {
        string line;
...
int main()
{
    ...
    try {
        ...
        py::object result = face_recognition.attr("recognize_face")("manoj.jpg");
        std::cout << "Prediction: " << result.cast<string>() << std::endl;
